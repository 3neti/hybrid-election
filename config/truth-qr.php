...
*/
    ...
    'transport'  => TransportCodec::class,      // implements TransportCodec
    'envelope'   => Envelope::class,           // implements TruthCodec\Contracts\Envelope
    ...
    */
    'writer' => [
        'driver' => env('TRUTH_QR_WRITER', 'endroid'),
        'format' => env('TRUTH_QR_FORMAT', 'png'),
